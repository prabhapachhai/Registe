...
namespace FileUpload.Helpers
{
    ...
    class FrameWorkHelpers
    {
      ...
      //  internal static IJavaScriptExecutor javascriptExecutor;
        ...
        public static void  ActionSendKey( string locator, IdentifierType identifierType)
        {
            IWebElement text = GetElement(locator, identifierType);
            Actions action = new Actions(_webDriver);
            action.SendKeys("text").Perform();
           
        }
        public static void FileUploadNonStandardHtmlUsingAutoIt( string exe,string path)
        {
           Process.Start(@"C:\Users\12144\Downloads\FileUploadExample.exe", @"C:\Users\12144\Documents\9_Sept_2020_Static_Keyword.docx");
        }
